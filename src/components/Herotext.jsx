...
const words = ['CREATE YOUR PROFILE, BROWSE CLIENT BRIEFS, OFFER YOUR SERVICES, SHARE YOUR WORK', 'Create your profile', 'Browse client briefts', 'Offer your services', 'Share your work'];
